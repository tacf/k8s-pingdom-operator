...
func (in *PingdomOperatorCheck) DeepCopy() *PingdomOperatorCheck {
	if in == nil {
		return nil
	}
	out := new(PingdomOperatorCheck)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PingdomOperatorList) DeepCopyInto(out *PingdomOperatorList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]PingdomOperator, len(*in))
		for i := range *in {
...
func (in *PingdomOperatorSpec) DeepCopyInto(out *PingdomOperatorSpec) {
	*out = *in
	if in.Checks != nil {
		...
		*out = make([]PingdomOperatorCheck, len(*in))
		copy(*out, *in)
	}
	return
}
